...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=./android/armv7-a --enable-cross-compile --arch=arm --enable-nonfree --enable-asm --cpu=cortex-a8 --enable-neon --cc=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --sysroot=/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -mfpu=neon -marm -mcpu=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm//usr/lib -L/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm//usr/lib  -nostdlib -lc -lm -ldl -llog' --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-encoders --enable-avformat --disable-optimizations --disable-doc --enable-pthreads --disable-yasm --enable-zlib --enable-pic --enable-small
...
ARCH=arm
CC=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
CXX=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
AS=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -s -f
STRIP=/home/lucas/android/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-strip
CPPFLAGS= --sysroot=/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -mfpu=neon -marm -mcpu=cortex-a8 -mcpu=cortex-a8 -std=c99 -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -mfloat-abi=softfp -mfpu=neon -marm -mcpu=cortex-a8 -mcpu=cortex-a8 -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -Wl,-rpath-link=/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm//usr/lib -L/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog  --sysroot=/home/lucas/android/android-ndk-r8b/platforms/android-8/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
NOREDZONE_FLAGS=
libavcodec_VERSION=55.2.100
libavcodec_VERSION_MAJOR=55
libavcodec_VERSION_MINOR=2
libavdevice_VERSION=55.0.100
libavdevice_VERSION_MAJOR=55
libavdevice_VERSION_MINOR=0
libavfilter_VERSION=3.48.105
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=48
libavformat_VERSION=55.1.100
...
libavutil_VERSION=52.24.100
libavutil_VERSION_MAJOR=52
libavutil_VERSION_MINOR=24
